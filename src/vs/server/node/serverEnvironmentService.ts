...
export const IServerEnvironmentService = refineServiceDecorator<IEnvironmentService, IServerEnvironmentService>(
  IEnvironmentService,
);
...
export class ServerEnvironmentService extends NativeEnvironmentService implements IServerEnvironmentService {
	...
	@memoize
	get machineSettingsResource(): URI { return joinPath(
    URI.file(join(this.userDataPath, "Machine")),
    "settings.json",
  ); }
	@memoize
	get mcpResource(): URI { return joinPath(
    URI.file(join(this.userDataPath, "User")),
    "mcp.json",
  ); }
	override get args(): ServerParsedArgs { return super.args as ServerParsedArgs; }
	@memoize
	get reconnectionGraceTime(): number { return parseGraceTime(
