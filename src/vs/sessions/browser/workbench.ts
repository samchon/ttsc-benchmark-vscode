  ...
  implements IAgentWorkbenchLayoutService
{
  ...
  focusPart(part: Parts, targetWindow: Window = mainWindow): void {
    switch (part) {
      ...
      case Parts.CHATBAR_PART:
        this.paneCompositeService
          .getActivePaneComposite(ViewContainerLocation.ChatBar)
          ?.focus();
        break;
      default: {
  ...
  private _applyInitialEditorSize(): void {
    ...
    const mainAreaWidth =
      this.workbenchGrid.getViewSize(this.chatBarPartView).width +
