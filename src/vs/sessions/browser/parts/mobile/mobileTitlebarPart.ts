...
export class MobileTitlebarPart extends Disposable {
	...
	private showAccountPanel(): void {
      ...
      $("div.mobile-account-sheet-profile-info"),
        ...
        profileInfo,
        $(
          "div.mobile-account-sheet-name",
        ),
      ).textContent = localize("mobileAccount.loading", "Loading...");
		} else if (this.accountName) {
			append(
        profileInfo,
        $("div.mobile-account-sheet-name"),
      ).textContent = this.accountName;
      ...
      ).textContent = localize("mobileAccount.signedOut", "Not signed in");
		}
        ...
        $("div.mobile-account-sheet-section"),
			...
			const dashboardElement = this.chatDashboardService.createDashboardElement(
        store,
      );
			if (dashboardElement) {
      ...
      $("div.mobile-account-sheet-actions"),
        ...
        $("button.mobile-account-sheet-action", { type: "button" }),
          ...
          ...ThemeIcon.asClassNameArray(icon),
			...
			append(
        row,
        $("span.mobile-account-sheet-action-label"),
