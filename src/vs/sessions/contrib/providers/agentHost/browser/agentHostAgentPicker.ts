...
import {
  type IChatInputPickerOptions,
  ChatInputPickerActionViewItem,
} from "../../../../../workbench/contrib/chat/browser/widget/input/chatInputPickerActionItem.js";
  ...
  class extends Action2 {
    constructor() {
      super({
        ...
        f1: false,
        menu: [
          { id: MenuIdAgentHostAgentPicker, group: "configure", order: 1 },
        ],
      });
    }
...
class AgentHostAgentPickerActionItem extends ChatInputPickerActionViewItem {
  constructor(
    ...
    const makeAgentAction = (
      agent: CustomizationAgentRef,
    ): IActionWidgetDropdownAction => {
    ...
    const actionProvider: IActionWidgetDropdownActionProvider = {
      getActions: () => {
        ...
        const agents = [...this.delegate.currentAgents()].sort(
          (a, b) => a.name.localeCompare(b.name) || a.uri.localeCompare(b.uri),
        );
    ...
    > = {
      ...
      reporter: {
        ...
        name: "NewChatAgentHostAgentPicker",
        includeOptions: true,
      },
    };
  ...
  protected override renderLabel(element: HTMLElement): IDisposable | null {
    ...
    const label = current
      ? current.name
      : nls.localize("agentPickerDefault", "Agent");
  ...
  implements IWorkbenchContribution
{
  ...
  constructor(
    ...
    const factory = (
      _action: import("../../../../../base/common/actions.js").IAction,
      _options: import("../../../../../base/browser/ui/actionbar/actionViewItems.js").IActionViewItemOptions,
      scopedInstantiationService: import("../../../../../platform/instantiation/common/instantiation.js").IInstantiationService,
    ) => {
      ...
      const delegate: IAgentPickerDelegate = {
        ...
        currentAgents: () => {
          ...
          return session && provider
            ? provider.getCustomAgents(session.sessionId)
            : [];
        },
