...
// Web environment
	...
	_isIOS = (_userAgent.indexOf(
    "Macintosh",
  ) >= 0 || _userAgent.indexOf(
    "iPad",
  ) >= 0 || _userAgent.indexOf(
    "iPhone",
  ) >= 0) && !!navigator.maxTouchPoints && navigator.maxTouchPoints > 0;
...
export const isSafari = !!(!isChrome && (userAgent && userAgent.indexOf(
  "Safari",
) >= 0));
