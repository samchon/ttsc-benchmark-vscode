...
export class ThemeConfiguration {
	...
	public get colorCustomizations(): IColorCustomizations {
		return this.configurationService.getValue<IColorCustomizations>(
      ThemeSettings.COLOR_CUSTOMIZATIONS,
    ) || {};
	}

	public get tokenColorCustomizations(): ITokenColorCustomizations {
		const tokenColorCustomization = this.configurationService.getValue<ITokenColorCustomizations>(
