  ...
  implements IDefaultAccountProvider
{
  ...
  private async getDefaultAccountFromAuthenticatedSessions(
    ...
    try {
      ...
      const tokenEntitlementsResult = entitlementsData?.chat_enabled
        ? await this.getTokenEntitlements(sessions, accountPolicyData, options)
        : undefined;
      ...
      if (tokenEntitlementsResult?.data) {
        ...
        policyData.cloud_session_storage_enabled =
          tokenEntitlementsData.policyData.cloud_session_storage_enabled;
      ...
      if (chatData) {
        ...
        return {
          policyData: {
            ...
            cloud_session_storage_enabled: tokenMap.has(
              "cloud_session_storage_enabled",
            )
              ? tokenMap.get("cloud_session_storage_enabled") === "1"
              : undefined,
          },
          copilotTokenInfo: {
            sn: tokenMap.get("sn"),
