...
class LogOutputChannels extends Disposable implements IWorkbenchContribution {
	...
	private registerLogChannel(logger: ILoggerResource): void {
      ...
      logger.resource,
		...
		const remoteLogger = existingChannel && isSingleSourceOutputChannelDescriptor(
      existingChannel,
    ) && existingChannel.source.resource.scheme === Schemas.vscodeRemote ? this.loggerService.getRegisteredLogger(
