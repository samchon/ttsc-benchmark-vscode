      ...
      this.currentCell.uri,
        ...
        this.currentCell,
			...
			if (scrollBottom <= editorBottom && cellIsRunning) {
				const isAlreadyIcon = this._executionOrderContent.classList.contains(
          "sticky-spinner",
        );
            ...
            ...renderLabelWithIcons(`$(${icon.id})`),
				...
				const wasStickyHere = this._executionOrderLabel.classList.contains(
          "sticky",
        );
				this._executionOrderLabel.classList.remove("sticky");
				...
				const iconIsPresent = this._executionOrderContent.querySelector(
          ".codicon",
        ) !== null;
				...
				const currentlySticky = this._executionOrderLabel.classList.contains(
          "sticky",
        );
				this._executionOrderLabel.classList.remove("sticky");
