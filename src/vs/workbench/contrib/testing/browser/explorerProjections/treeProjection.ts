	...
	private storeItem(treeElement: TreeTestItemElement) {
      ...
      treeElement.test.item.extId,
		...
		if (prevState) {
			...
			refreshComputedState(computedStateAccessor, treeElement, undefined, !!treeElement.ownDuration).forEach(
        i => i.fireChange(),
      );
		}
	}
