...
const stmtCoverageText = (coverage: CoverageBarSource) => localize(
  "statementCoverage",
...
const fnCoverageText = (coverage: CoverageBarSource) => coverage.declaration && localize(
  "functionCoverage",
...
const branchCoverageText = (coverage: CoverageBarSource) => coverage.branch && localize(
  "branchCoverage",
