...
export namespace TestingContextKeys {
    ...
    {
      type: "boolean",
      description: localize("testing.supportsContinuousRun", "Indicates whether continuous test running is supported"),
    },
  );
    ...
    {
      type: "boolean",
      description: localize("testing.hasInlineCoverageDetails", "Indicates whether detailed per-line coverage is available for inline display"),
    },
  );
