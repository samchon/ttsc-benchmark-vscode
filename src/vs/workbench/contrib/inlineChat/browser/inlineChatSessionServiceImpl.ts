...
export class InlineChatSessionServiceImpl implements IInlineChatSessionService {
	...
	createSession(editor: IActiveCodeEditor): IInlineChatSession {
      ...
      { canUseTools: false },
		...
		const terminationState = observableValue<InlineChatSessionTerminationState | undefined>(
      this,
      undefined,
    );
...
export class InlineChatEnabler {
	...
	constructor(
		...
		this.#ctxHasNotebookProvider = CTX_INLINE_CHAT_HAS_NOTEBOOK_AGENT.bindTo(
      contextKeyService,
    );
