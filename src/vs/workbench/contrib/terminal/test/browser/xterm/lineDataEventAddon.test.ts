...
suite("LineDataEventAddon", () => {
  ...
  suite("onLineData", () => {
    ...
    test(
      "should fire when a non-wrapped line ends with a line feed",
      async () => {
    ...
    test(
      "should not fire on cursor move when the backing process is not on Windows",
      async () => {
    ...
    test(
      "should fire on cursor move when the backing process is on Windows",
      async () => {
