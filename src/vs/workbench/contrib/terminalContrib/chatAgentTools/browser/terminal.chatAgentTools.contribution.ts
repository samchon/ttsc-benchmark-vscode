...
class ShellIntegrationTimeoutMigrationContribution extends Disposable implements IWorkbenchContribution {
	...
	constructor(
      ...
      TerminalSettingId.ShellIntegrationTimeout,
		...
		if (deprecated.userValue !== undefined && target.userValue === undefined && isNumber(
      deprecated.userValue,
		...
		if (deprecated.workspaceValue !== undefined && target.workspaceValue === undefined && isNumber(
...
export class ChatAgentToolsContribution extends Disposable implements IWorkbenchContribution {
	...
	constructor(
      ...
      _toolsService.executeToolSet.addTool(GetTerminalOutputToolData),
		...
		const killTerminalTool = _instantiationService.createInstance(
      KillTerminalTool,
    );
		this._register(
      _toolsService.registerTool(KillTerminalToolData, killTerminalTool),
		...
		const sendToTerminalTool = _instantiationService.createInstance(
      SendToTerminalTool,
    );
		this._register(
      ...
      _toolsService.readToolSet.addTool(GetTerminalLastCommandToolData),
		...
		const getTaskOutputTool = _instantiationService.createInstance(
      GetTaskOutputTool,
    );
		this._register(
      _toolsService.registerTool(GetTaskOutputToolData, getTaskOutputTool),
		...
		const createAndRunTaskTool = _instantiationService.createInstance(
      CreateAndRunTaskTool,
    );
		this._register(
      _toolsService.registerTool(CreateAndRunTaskToolData, createAndRunTaskTool),
    );
