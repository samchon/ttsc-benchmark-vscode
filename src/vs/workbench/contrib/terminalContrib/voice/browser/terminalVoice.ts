...
export class TerminalVoiceSession extends Disposable {
	...
	static getInstance(instantiationService: IInstantiationService): TerminalVoiceSession {
		if (!TerminalVoiceSession._instance) {
			TerminalVoiceSession._instance = instantiationService.createInstance(
	...
	constructor(
      ...
      this._terminalService.onDidDisposeInstance(() => this.stop()),
		...
		this._terminalDictationInProgress = TerminalContextKeys.terminalDictationInProgress.bindTo(
      contextKeyService,
    );
	}
