...
suite("ChatContext", () => {
  ...
  test(
    "shows Open Editors for regular Copilot CLI sessions with eligible editors",
    () => {
      assert.strictEqual(
  ...
  test(
    "hides Open Editors for Agent Host sessions with eligible editors",
    () => {
      assert.strictEqual(
        shouldShowOpenEditorsContext(
  ...
  test(
    "hides Open Editors for locked Agent Host ids without a session resource",
    () => {
      assert.strictEqual(
        shouldShowOpenEditorsContext(
