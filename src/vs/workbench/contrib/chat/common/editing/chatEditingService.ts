...
export const IChatEditingService = createDecorator<IChatEditingService>(
  "chatEditingService",
);
...
export const chatEditingWidgetFileStateContextKey = new RawContextKey<ModifiedFileEntryState>(
...
export const chatEditingAgentSupportsReadonlyReferencesContextKey = new RawContextKey<boolean>(
...
export const chatEditingResourceContextKey = new RawContextKey<string | undefined>(
  "chatEditingResource",
  undefined,
);
export const inChatEditingSessionContextKey = new RawContextKey<boolean | undefined>(
  "inChatEditingSession",
  undefined,
);
export const hasUndecidedChatEditingResourceContextKey = new RawContextKey<boolean | undefined>(
  "hasUndecidedChatEditingResource",
  false,
);
export const hasAppliedChatEditsContextKey = new RawContextKey<boolean | undefined>(
  "hasAppliedChatEdits",
  false,
);
export const applyingChatEditsFailedContextKey = new RawContextKey<boolean | undefined>(
  "applyingChatEditsFailed",
  false,
);
