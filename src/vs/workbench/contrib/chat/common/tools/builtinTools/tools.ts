...
export class BuiltinToolsContribution extends Disposable implements IWorkbenchContribution {
	...
	constructor(
      ...
      instantiationService.createInstance(ManageTodoListTool),
		...
		const confirmationTool = instantiationService.createInstance(
      ConfirmationTool,
    );
		this._register(
      ...
      toolsService.registerTool(
		...
		const taskCompleteTool = instantiationService.createInstance(
      TaskCompleteTool,
    );
		this._register(
      toolsService.registerTool(TaskCompleteToolData, taskCompleteTool),
		...
		const setArtifactsTool = instantiationService.createInstance(
      SetArtifactsTool,
    );
		const setArtifactRulesTool = instantiationService.createInstance(
      ...
      instantiationService.createInstance(RunSubagentTool),
        ...
        runSubagentTool,
			...
			toolSetRegistration = toolsService.agentToolSet.addTool(
        runSubagentToolData,
      );
		};
