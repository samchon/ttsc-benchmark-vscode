...
export class ChatServiceTelemetry {
	...
	notifyUserAction(action: IChatUserActionEvent): void {
        ...
        "interactiveSessionCopy",
        {
          ...
          command: action.command,
			...
			this.telemetryService.publicLog2<ChatInsertEvent, ChatInsertClassification>(
        ...
        "interactiveSessionApply",
        {
          ...
          editsProposed: !!action.action.editsProposed,
			...
			this.telemetryService.publicLog2<ChatTerminalEvent, ChatTerminalClassification>(
        "interactiveSessionRunInTerminal",
        {
          ...
          command: action.command,
			...
			this.telemetryService.publicLog2<ChatFollowupEvent, ChatFollowupClassification>(
        "chatFollowupClicked",
        {
          agentId: action.agentId ?? "",
          command: action.command,
			...
			this.telemetryService.publicLog2<ChatEditHunkEvent, ChatEditHunkClassification>(
        "chatEditHunk",
        {
          agentId: action.agentId ?? "",
	...
	retrievedFollowups(agentId: string, command: string | undefined, numFollowups: number): void {
		this.telemetryService.publicLog2<ChatFollowupsRetrievedEvent, ChatFollowupsRetrievedClassification>(
...
export class ChatRequestTelemetry {
	...
	private resolveModelId(userSelectedModelId: string | undefined): string | undefined {
		return userSelectedModelId && this.languageModelsService.lookupLanguageModel(
      userSelectedModelId,
    )?.id;
	}
}
