...
export class ChatDebugOverviewView extends Disposable {
	...
	private load(): void {
      ...
      new Button(titleActions, {
        ariaLabel: localize("chatDebug.revealChatSession", "Reveal Chat Session"),
	...
	private getLocationLabel(location: ChatAgentLocation): string {
		switch (location) {
			case ChatAgentLocation.Chat: return localize(
        "chatDebug.location.chat",
        "Chat Panel",
      );
			case ChatAgentLocation.Terminal: return localize(
        "chatDebug.location.terminal",
        "Terminal",
      );
			case ChatAgentLocation.Notebook: return localize(
        "chatDebug.location.notebook",
        "Notebook",
      );
			case ChatAgentLocation.EditorInline: return localize(
	...
	private renderMetricsContent(container: HTMLElement, events: readonly IChatDebugEvent[]): void {
      ...
      {
        label: localize("chatDebug.metric.totalInputTokens", "Total Input Tokens"),
        value: fmt.format(totalInputTokens),
      },
      {
        label: localize("chatDebug.metric.totalOutputTokens", "Total Output Tokens"),
        value: fmt.format(totalOutputTokens),
      },
      {
        label: localize("chatDebug.metric.totalCachedInputTokens", "Total Cached Input Tokens"),
