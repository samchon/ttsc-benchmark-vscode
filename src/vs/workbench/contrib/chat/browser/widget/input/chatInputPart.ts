  ...
  constructor(
    ...
    const resetCurrentLanguageModelIfUnavailable = () => {
      ...
      if (this._currentSessionType === SessionType.CopilotCLI) {
        if (
          shouldResetOnModelListChange(modelIdentifier, models) &&
        ...
        MenuId.ChatInput,
        {
          ...
          actionViewItemProvider: (action, options) => {
            ...
            if (
              ...
              action.id === OpenAgentHostCustomAgentPickerAction.ID &&
              action instanceof MenuItemAction &&
              this._widget
            ) {
      ...
      this.instantiationService.createInstance(
        ...
        MenuId.ChatInputSecondary,
        {
          ...
          responsiveBehavior: {
            ...
            getActionMinWidth: (action) =>
              agentHostShortPickerIds.has(action.id) ? 22 : undefined,
          },
          actionViewItemProvider: (action, options) => {
            if (
              (action.id === OpenSessionTargetPickerAction.ID ||
