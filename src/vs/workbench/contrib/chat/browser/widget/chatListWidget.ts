...
export class ChatListWidget extends Disposable {
	...
	constructor(
      ...
      this.instantiationService.createChild(
		...
		const overflowWidgetsContainer = options.overflowWidgetsDomNode ?? document.createElement(
      "div",
    );
		...
		const editorOptions = options.editorOptions ?? this._register(
	...
	private handleContextMenu(e: ITreeContextMenuEvent<ChatTreeItem | null>): void {
		...
		const isKatexElement = target.closest(
