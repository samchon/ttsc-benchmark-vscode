...
export const IChatWidgetService = createDecorator<IChatWidgetService>(
  "chatWidgetService",
);
...
export const IQuickChatService = createDecorator<IQuickChatService>(
  "quickChatService",
);
...
export const IChatCodeBlockContextProviderService = createDecorator<IChatCodeBlockContextProviderService>(
