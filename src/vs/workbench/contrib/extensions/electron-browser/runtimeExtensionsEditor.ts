...
export const CONTEXT_EXTENSION_HOST_PROFILE_RECORDED = new RawContextKey<boolean>(
...
export class RuntimeExtensionsEditor extends AbstractRuntimeExtensionsEditor {
	...
	constructor(
      ...
      menuService,
		...
		this._extensionsHostRecorded = CONTEXT_EXTENSION_HOST_PROFILE_RECORDED.bindTo(
      contextKeyService,
    );
		this._profileSessionState = CONTEXT_PROFILE_SESSION_STATE.bindTo(
      contextKeyService,
    );
