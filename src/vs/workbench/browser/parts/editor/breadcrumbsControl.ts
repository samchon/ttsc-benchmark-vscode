...
export class BreadcrumbsControl {
	...
	constructor(
		...
		this._cfUseQuickPick = BreadcrumbsConfig.UseQuickPick.bindTo(
      configurationService,
    );
		this._cfShowIcons = BreadcrumbsConfig.Icons.bindTo(configurationService);
		this._cfTitleScrollbarSizing = BreadcrumbsConfig.TitleScrollbarSizing.bindTo(
      configurationService,
    );
		this._cfTitleScrollbarVisibility = BreadcrumbsConfig.TitleScrollbarVisibility.bindTo(
      configurationService,
    );
	...
	update(): boolean {
      ...
      toDisposable(() => this._widget.setItems([])),
		...
		const updateScrollbarSizeListener = this._cfTitleScrollbarSizing.onDidChange(
      updateScrollbarSizing,
    );
		const updateScrollbarVisibilityListener = this._cfTitleScrollbarVisibility.onDidChange(
      updateScrollbarSizing,
    );
