...
export class CommandCenterControl {
	...
	constructor(
      ...
      Event.filter(quickInputService.onShow, () => isActiveDocument(this.element), this._disposables)(
        () => {
...
class CommandCenterCenterViewItem extends BaseActionViewItem {
	...
	constructor(
      ...
      options,
		...
		this._hoverDelegate = options.hoverDelegate ?? getDefaultHoverDelegate(
      "mouse",
    );
	}
