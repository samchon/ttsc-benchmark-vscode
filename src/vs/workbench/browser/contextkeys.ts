...
export class WorkbenchContextKeysHandler extends Disposable {
	...
	constructor(
      ...
      this.contextKeyService,
		...
		// to a remote.
		this.openFolderWorkspaceSupportContext = OpenFolderWorkspaceSupportContext.bindTo(
      this.contextKeyService,
    );
      ...
      this.contextKeyService,
		...
		this.isAuxiliaryWindowFocusedContext = IsAuxiliaryWindowFocusedContext.bindTo(
      this.contextKeyService,
    );
      ...
      this.contextKeyService,
		...
		this.isMainEditorCenteredLayoutContext = IsMainEditorCenteredLayoutContext.bindTo(
      this.contextKeyService,
    );
