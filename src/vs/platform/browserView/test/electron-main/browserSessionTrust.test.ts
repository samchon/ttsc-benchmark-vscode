...
class TestApplicationStorageMainService {
	...
	readonly store = sinon.stub<[string, string | number | boolean | object | null | undefined, StorageScope, StorageTarget], void>().callsFake(
    (key, value) => {
      this.data.set(key, String(value));
    },
  );
	readonly remove = sinon.stub<[string, StorageScope], void>().callsFake(
    key => {
