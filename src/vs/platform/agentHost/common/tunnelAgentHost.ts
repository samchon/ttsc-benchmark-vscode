...
export class TunnelTags {
	...
	constructor(readonly value: readonly string[] | undefined) {
		if (value) {
          ...
          "_",
        ) && tag !== TUNNEL_LAUNCHER_LABEL && !name) {
					name = tag;
				}
			}
 ...
 */
export const ITunnelAgentHostMainService = createDecorator<ITunnelAgentHostMainService>(
 ...
 */
export const ITunnelAgentHostHostingService = createDecorator<ITunnelAgentHostHostingService>(
