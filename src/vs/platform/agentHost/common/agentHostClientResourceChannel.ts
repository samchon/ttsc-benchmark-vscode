		...
		switch (command) {
          ...
          encoding: ContentEncoding.Base64,
			...
			case "resourceDelete": {
				...
				await this._fileService.del(
          URI.parse(params.uri as unknown as string),
          ...
          URI.parse(params.source as unknown as string),
          URI.parse(params.destination as unknown as string),
          !params.failIfExists,
        );
