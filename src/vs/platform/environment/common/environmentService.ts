...
export abstract class AbstractNativeEnvironmentService implements INativeEnvironmentService {
	...
	@memoize
	get appSettingsHome(): URI { return URI.file(
    join(this.userDataPath, "User"),
  ); }
	...
	@memoize
	get userRoamingDataHome(): URI { return this.appSettingsHome.with({
	...
	@memoize
	get untitledWorkspacesHome(): URI { return URI.file(
    join(this.userDataPath, "Workspaces"),
  ); }
	...
	@memoize
	get debugExtensionHost(): IExtensionHostDebugParams { return parseExtensionHostDebugPort(
    this.args,
    this.isBuilt,
  ); }
	...
	@memoize
	get logLevel(): string | undefined { return this.args.log?.find(
