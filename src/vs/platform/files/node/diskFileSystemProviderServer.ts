...
export abstract class AbstractDiskFileSystemProviderChannel<T> extends Disposable implements IServerChannel<T> {
	...
	call<TResult>(ctx: T, command: string, args: unknown[]): Promise<TResult> {
        ...
        args[0] as UriComponents,
			...
			case "realpath": return this.realpath(
        uriTransformer,
        args[0] as UriComponents,
      ) as Promise<TResult>;
			case "readdir": return this.readdir(
        uriTransformer,
        args[0] as UriComponents,
      ) as Promise<TResult>;
        ...
        args[2] as number,
			...
			case "readFile": return this.readFile(
        uriTransformer,
        args[0] as UriComponents,
        args[1] as IFileAtomicReadOptions,
      ) as Promise<TResult>;
			case "write": return this.write(
        args[0] as number,
        args[1] as number,
        args[2] as VSBuffer,
        args[3] as number,
        args[4] as number,
			...
			case "writeFile": return this.writeFile(
        uriTransformer,
        args[0] as UriComponents,
        args[1] as VSBuffer,
        ...
        args[2] as IFileOverwriteOptions,
			...
			case "cloneFile": return this.cloneFile(
        uriTransformer,
        args[0] as UriComponents,
        args[1] as UriComponents,
      ) as Promise<TResult>;
			case "mkdir": return this.mkdir(
        uriTransformer,
        args[0] as UriComponents,
      ) as Promise<TResult>;
        ...
        args[3] as IWatchOptions,
			...
			case "unwatch": return this.unwatch(
        args[0] as string,
        args[1] as number,
      ) as Promise<TResult>;
		}
	...
	listen<TResult>(ctx: T, event: string, args: unknown[]): Event<TResult> {
		...
		switch (event) {
			case "fileChange": return this.onFileChange(
        uriTransformer,
        args[0] as string,
      ) as Event<TResult>;
			case "readFileStream": return this.onReadFileStream(
        uriTransformer,
        args[0] as URI,
