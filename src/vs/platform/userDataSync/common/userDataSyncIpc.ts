...
export class UserDataSyncAccountServiceChannelClient extends Disposable implements IUserDataSyncAccountService {
	...
	get onTokenFailed(): Event<boolean> { return this.channel.listen<boolean>(
    "onTokenFailed",
  ); }
	...
	constructor(private readonly channel: IChannel) {
		super();
		this.channel.call<IUserDataSyncAccount | undefined>("_getInitialData").then(
      account => {
        this._account = account;
        this._register(
          this.channel.listen<IUserDataSyncAccount | undefined>("onDidChangeAccount")(
            account => {
              this._account = account;
