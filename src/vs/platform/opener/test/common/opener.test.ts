...
suite("extractSelection", () => {
  ...
  test(
    "extractSelection with startLineNumber and startColumn in L format",
    async () => {
  ...
  test(
    "extractSelection with range and no column number in L format",
    async () => {
  ...
  test(
    "extractSelection with range and no column number in L format only for start",
    async () => {
  ...
  test(
    "extractSelection with range and no column number in L format only for end",
    async () => {
  ...
  test("withSelection with startLineNumber and startColumn", async () => {
    assert.deepStrictEqual(
      withSelection(URI.parse("file:///some/file.js"), { startLineNumber: 73, startColumn: 84 }).toString(),
      "file:///some/file.js#73%2C84",
    );
  });

  test(
    "withSelection with startLineNumber, startColumn and endLineNumber",
    async () => {
      assert.deepStrictEqual(
        withSelection(URI.parse("file:///some/file.js"), { startLineNumber: 73, startColumn: 84, endLineNumber: 83 }).toString(),
  ...
  test(
    "withSelection with startLineNumber, startColumn and endLineNumber, endColumn",
    async () => {
      assert.deepStrictEqual(
        withSelection(URI.parse("file:///some/file.js"), { startLineNumber: 73, startColumn: 84, endLineNumber: 83, endColumn: 52 }).toString(),
