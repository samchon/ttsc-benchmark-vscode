...
export abstract class AbstractUpdateService implements IUpdateService {
	...
	protected async initialize(): Promise<void> {
      ...
      "update.mode",
		...
		const updateModeInspection = this.configurationService.inspect<"none" | "manual" | "start" | "default">(
      "update.mode",
    );
		const policyDisablesUpdates = updateModeInspection.policyValue !== undefined && !this.getProductQuality(
      updateModeInspection.policyValue,
    );
	...
	private async trackVersionChange(): Promise<void> {
      ...
      StorageTarget.MACHINE,
		...
		this.telemetryService.publicLog2<VersionChangeEvent, VersionChangeClassification>(
