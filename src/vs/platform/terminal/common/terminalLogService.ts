...
export class TerminalLogService extends Disposable implements ITerminalLogService {
	...
	trace(message: string, ...args: unknown[]): void { this._logger.trace(
    this._formatMessage(message),
    args,
  ); }
	debug(message: string, ...args: unknown[]): void { this._logger.debug(
    this._formatMessage(message),
    args,
  ); }
	info(message: string, ...args: unknown[]): void { this._logger.info(
    this._formatMessage(message),
    args,
  ); }
	warn(message: string, ...args: unknown[]): void { this._logger.warn(
    this._formatMessage(message),
    args,
  ); }
