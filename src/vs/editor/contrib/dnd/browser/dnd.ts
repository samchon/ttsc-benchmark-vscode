...
export class DragAndDropController extends Disposable implements IEditorContribution {
	...
	constructor(editor: ICodeEditor) {
      ...
      this._editor.onMouseDrag(
        (e: IEditorMouseEvent) => this._onEditorMouseDrag(e),
      ),
    );
		this._register(
      this._editor.onMouseDrop(
        (e: IPartialEditorMouseEvent) => this._onEditorMouseDrop(e),
      ),
    );
		this._register(
	...
	private _onEditorMouseDrop(mouseEvent: IPartialEditorMouseEvent): void {
		if (mouseEvent.target && (this._hitContent(
      mouseEvent.target,
    ) || this._hitMargin(mouseEvent.target)) && mouseEvent.target.position) {
          ...
          CursorChangeReason.Explicit,
				...
				(
					(
						...
						this._dragSelection.getEndPosition().equals(
              newCursorPosition,
            ) || this._dragSelection.getStartPosition().equals(
              newCursorPosition,
            )
