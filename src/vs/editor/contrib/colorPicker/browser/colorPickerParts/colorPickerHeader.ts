...
export class ColorPickerHeader extends Disposable {
	...
	constructor(container: HTMLElement, private readonly model: ColorPickerModel, themeService: IThemeService, private type: ColorPickerWidgetType) {
      ...
      "Click to toggle color options (rgb/hsl/hex)",
		...
		this._originalColorNode.style.backgroundColor = Color.Format.CSS.format(
      this.model.originalColor,
    ) || "";

		this.backgroundColor = themeService.getColorTheme().getColor(
      ...
      model.onDidChangePresentation(this.onDidChangePresentation, this),
		...
		this._pickedColorNode.style.backgroundColor = Color.Format.CSS.format(
      model.color,
    ) || "";
