...
export class InlineSuggestionsView extends Disposable {
	...
	private readonly _indicatorIsHoverVisible = observableValue<IObservable<boolean> | undefined>(
    this,
    undefined,
  );
	...
	constructor(
      ...
      this._store,
		...
		this._fontFamily = this._editorObs.getOption(EditorOption.inlineSuggest).map(
      val => val.fontFamily,
    );
